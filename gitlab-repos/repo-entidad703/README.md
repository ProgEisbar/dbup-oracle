...
```text
dbup/ddl/dev/ENTIDAD703/DBUP-1234_descripcion.sql
dbup/ddl/shared/ENTIDAD703/DBUP-1234_descripcion.sql
```
...
```text
DBUP_QA_REPO_URL=https://gitlab.com/{GITLAB_GROUP_PATH}/qa-dbup/entidad703.git
...
{{ENTIDAD}}       -> ENTIDAD703
{{PARAM}}         -> PARAM703
{{USER_SERVICES}} -> USER_SERVICES703
```
