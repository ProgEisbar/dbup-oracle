...
```text
dbup/ddl/dev/ENTIDAD701/DBUP-1234_descripcion.sql
...
```text
DBUP_QA_REPO_URL=https://gitlab.com/{GITLAB_GROUP_PATH}/qa-dbup/entidad701.git
...
{{ENTIDAD}}       -> ENTIDAD701
{{PARAM}}         -> PARAM701
{{USER_SERVICES}} -> USER_SERVICES701
```
