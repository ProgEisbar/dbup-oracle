...
```text
dbup/ddl/dev/ENTIDAD702/DBUP-1234_descripcion.sql
dbup/ddl/shared/ENTIDAD702/DBUP-1234_descripcion.sql
```
...
```text
DBUP_QA_REPO_URL=https://gitlab.com/{GITLAB_GROUP_PATH}/qa-dbup/entidad702.git
...
{{ENTIDAD}}       -> ENTIDAD702
{{PARAM}}         -> PARAM702
{{USER_SERVICES}} -> USER_SERVICES702
```
